...
class MeshType_1d_nervepath1(Scaffold_base):
    ...
    def generateBaseMesh(cls, region, options):
        ...
        reducedFile = "C:\\Users\\mlin865\\manInBox\\files from Jen\\vagusNervesIn3DWB.json"
        extractNerveList = ['Meningeal branch of right vagus nerve',
                            ...
                            'Right vagus nerve',
                            'Left vagus nerve',
                            'Anterior esophageal vagus trunk',
                            'Posterior esophageal vagus trunk'
                            ]
        reducedList = []
        for feature in d1:
            marker_group = feature['region'].replace('__annotation/', '')
